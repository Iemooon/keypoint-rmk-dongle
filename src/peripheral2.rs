...
// ============================================================================
// KeyPoint-DG RIGHT half - peripheral id 1, matrix rows 6..11.
//
// Same minimal shape as the left half; pins transcribed from
// keypoint-rmk/src/peripheral.rs (the wired build's right half unchanged).
// ============================================================================
...
async fn main(spawner: Spawner) {
    ...
    // Battery ADC - KeyPoint right half: P0.02
    let adc_pin = p.P0_02.degrade_saadc();
    let saadc = init_adc(adc_pin, p.SAADC);
    // Wait for ADC calibration.
    saadc.calibrate().await;

    // KeyPoint RIGHT matrix: 6 rows x 8 cols (rows 6..11 in the shared keymap)
    ...
    // Start - id 1 pairs with the second PeripheralMatrixConfig on the receiver
    join3(
